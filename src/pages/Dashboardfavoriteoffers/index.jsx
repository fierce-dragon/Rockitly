...
const DashboardfavoriteoffersPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex font-satoshi h-[1400px] justify-end mx-auto relative w-full">
        <div className="sm:h-[7223px] h-[7226px] md:h-[7489px] mt-auto mx-auto md:px-5 w-full">
          ...
          <div className="absolute bg-gradient1  flex flex-col h-full inset-[0] items-start justify-center m-auto pl-1 py-1 w-full">
            ...
            <div className="flex flex-row font-satoshi gap-2.5 items-start justify-start md:ml-[0] ml-[93px] mt-[13px] w-[10%] md:w-full">
              <Text
            ...
            <Text
              className="capitalize mb-[7031px] md:ml-[0] ml-[480px] sm:text-[31px] md:text-[37px] text-[41px] text-white-A700"
          ...
          <div className="absolute backdrop-opacity-[0.5] blur-[200.00px] bottom-[16%] h-[789px] right-[0] rotate-[179deg] w-[15%]">
            <div className="h-[664px] ml-auto my-auto w-4/5">
              <Img
                ...
                src="images/img_ellipse264_51.png"
                alt="ellipse264"
              />
              <Img
        ...
        <div className="absolute flex md:flex-col flex-row gap-[49px] inset-x-[0] items-start justify-start max-w-[1404px] mx-auto md:px-5 top-[11%] w-full">
          <DashboardTradeHistoryColumn
            ...
            userfavoriteimage="images/img_location_indigo_a700.svg"
          />
          <div className="bg-gradient  border border-solid deep_purple_A400_4c_gray_50_00_border62 flex md:flex-1 flex-col gap-[31px] items-center justify-start md:mt-0 mt-[58px] p-[25px] sm:px-5 rounded-[10px] w-[73%] md:w-full">
            <div className="flex flex-col gap-2 items-center justify-start mt-0.5 w-[44%] md:w-full">
              <div className="flex flex-row gap-[27px] items-center justify-between w-[94%] md:w-full">
                <div className="flex flex-row gap-2 items-start justify-between w-[48%]">
                  <Text
                    className="capitalize mt-1 text-[17px] text-indigo-A700"
              ...
              <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-evenly w-full">
                ...
                <Line className="bg-white-A700_7e h-px sm:mt-0 mt-0.5 w-1/2" />
              </div>
            </div>
            <Text
              className="capitalize mb-[442px] text-[17px] text-center text-white-A700"
              size="txtSatoshiRegular17"
            >
              No offers found
            </Text>
...
export default DashboardfavoriteoffersPage;
